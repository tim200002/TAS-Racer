...
class WorldGenerator(object):
    ...
    def __init__(self, height_map, out):
        self.generated_world_path = out
        self.map = cv2.imread(height_map, -1)
        ...
        self.origin = np.array([self.map.shape[0] // 2 , self.map.shape[1] // 2])
